...
if __name__ == '__main__':
    ...
    train_dataset, val_dataset = data.prep_data(train_df, args.model_name), data.prep_data(val_df, args.model_name)
    
    model = model.TwitterSentimentModel(args.model_name)
    model.cuda()

    model_trainer = train.SentimentTrainer(args.epochs, args.lr)
